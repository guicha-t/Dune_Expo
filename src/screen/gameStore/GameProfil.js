...
export default class GameProfil extends Component {
  ...
  componentDidMount(){
    ...
    fetch('http://api.dune-table.com/v1/store/getAppStatus/' + this.props.navigation.getParam('id', this.props.id).toString(), {
       method: 'GET',
       headers: {
    ...
    fetch('http://api.dune-table.com/v1/store/nbAvis/' + this.props.navigation.getParam('id', this.props.id).toString(), {
       method: 'GET',
       headers: {
         Accept: 'application/json',
         'Content-Type': 'application/json',
  ...
  _ObtainApp(){
    if (this.state.Status === "\"1\""){
      ...
      fetch('http://api.dune-table.com/v1/store/buyAppDirecteur', {
          method: 'POST',
          Accept: 'application/json',
          headers: {
            'Content-Type': 'application/json',
