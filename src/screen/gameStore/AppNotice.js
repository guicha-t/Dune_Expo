        ...
        <View style={styles.containerBody}>
          ...
          <View style={{paddingTop:10, paddingBottom:30, justifyContent:'center', alignItems:'center'}}>
            <View style={{width:80, height:80}}>
              <Image
                ...
                source={{uri: 'http://176.31.252.134:7001/files/profs/' + this.state.Prof1.photo}}
              />
            </View>
          ...
          <View style={{paddingTop:10, paddingBottom:30, justifyContent:'center', alignItems:'center'}}>
            <View style={{width:80, height:80}}>
              <Image
                style={{flex: 1, borderRadius:50}}
                source={{uri: 'http://176.31.252.134:7001/files/profs/' + this.state.Prof2.photo}}
              />
            </View>
            <View style={styles.ProfContainer}>
          ...
          <View style={{paddingTop:10, paddingBottom:30, justifyContent:'center', alignItems:'center'}}>
            <View style={{width:80, height:80}}>
              <Image
                style={{flex: 1, borderRadius:50}}
                source={{uri: 'http://176.31.252.134:7001/files/profs/' + this.state.Prof3.photo}}
              />
            </View>
            <View style={styles.ProfContainer}>
          ...
          <View style={{paddingTop:10, paddingBottom:30, justifyContent:'center', alignItems:'center'}}>
            <View style={{width:80, height:80}}>
              <Image
                style={{flex: 1, borderRadius:50}}
                source={{uri: 'http://176.31.252.134:7001/files/profs/' + this.state.Prof4.photo}}
              />
            </View>
            <View style={styles.ProfContainer}>
          ...
          <View style={{paddingTop:10, paddingBottom:30, justifyContent:'center', alignItems:'center'}}>
            <View style={{width:80, height:80}}>
              <Image
                style={{flex: 1, borderRadius:50}}
                source={{uri: 'http://176.31.252.134:7001/files/profs/' + this.state.Prof5.photo}}
              />
            </View>
            <View style={styles.ProfContainer}>
